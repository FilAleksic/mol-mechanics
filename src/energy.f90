...
contains
    ...
    real*8 function Energy(Atom_Array, Bonding_Info)
        ...
        Energy = 0
        Energy = Energy + Stretch(Atom_Array) + Bending(Bonding_Info) + Torsional(Bonding_Info)
        Energy = Energy + nbVanDerWaals(Atom_Array) + nbElectrostatic(Atom_Array)
    end function
